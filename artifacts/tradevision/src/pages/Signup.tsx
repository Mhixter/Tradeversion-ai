          ...
          {step === 1 && (
            <div className="bg-card border border-border/50 rounded-2xl p-6 sm:p-8 shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-2 mb-5">
                {[{ n:"Google", e:"🇬" },{ n:"Apple",  e:"🍎" }].map(s => (
                  <button key={s.n} className="flex items-center justify-center gap-2 py-2.5 rounded-xl border border-border hover:border-primary/40 hover:bg-accent transition-colors text-sm font-semibold">
                    <span>{s.e}</span>Continue with {s.n}
                  </button>
                ))}
              </div>
